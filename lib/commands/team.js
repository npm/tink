...
// const usage = require('./utils/usage') Commented for now
...
const handleErrors = (err) => {
  ...
  summary.forEach(([prefix, message]) => log.error(prefix || err.code, message))
  detail.forEach(([prefix, message]) => log.error(prefix || err.code, message))
}
