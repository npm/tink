  ...
  builder (y) {
    return y.help().alias('help', 'h')
      ...
      .command({
        ...
        handler: (argv) => ({ scope, name }) => team('destroy', `${scope}:${name}`)
      })
      .command({
        command: 'add',
        aliases: ['a'],
        ...
        builder: (y) => y.help().alias('help', 'h').options({
          'name': {
            alias: 'n',
            describe: 'Name of the team where the user will be added',
            type: 'string',
            demandOption: true,
          },
          'user': {
        ...
        handler: (argv) => ({ user, name }) => team('add', name, user)
      })
      .command({
        command: 'rm',
        aliases: ['r'],
        ...
        builder: (y) => y.help().alias('help', 'h').options({
          'name': {
            alias: 'n',
            describe: 'Name of the team from where the user will be removed',
            type: 'string',
            demandOption: true,
          },
          'user': {
        ...
        handler: (argv) => ({ user, name }) => team('rm', name, user)
      })
      .command({
        command: 'ls',
        aliases: ['l'],
      ...
      .command({
        ...
        handler: (argv) => ({ scope, name }) => team('edit')
      })
  },
